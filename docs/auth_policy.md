...
- Hashed via argon2id configured for 19 MiB of memory, an iteration count of 2, and 2 degrees of parallelism. -> [node-argon2](https://www.npmjs.com/package//argon2)
