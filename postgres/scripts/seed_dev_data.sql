...
INSERT INTO end_user (username, password_hash, totp_secret, email) VALUES
    ('user1',
...
INSERT INTO post (username, title, content, timestamp) VALUES
    ('user1', 'To Sprinkle or Not To Sprinkle', 'What do you consider to be the classic donut? Sprinkled or glazed? Does a simple glaze cut it? There''s hundreds and thousands of options to consider.', '2024-11-23 13:37:02'),
    ('user1', 'Pancakes or Waffles: The Never Ending Debate', 'Why do we feel the need to pit them against one another? Why can''t pancakes and waffles live in harmony?', '2024-11-23 19:14:16'),
    ('user2', 'Dessert Sushi - should it exist?', 'I personally think it is an abomination. ''Red Hots'' are not a suitable wasabi substitute!', '2024-11-24 15:14:32'),
    ('John Doe', 'OAJSDASDJ', 'OASJDAISDJ', '2026-03-12 10:42:45');
